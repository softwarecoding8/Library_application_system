...
public class HeaderFooterOrderPageEvent extends PdfPageEventHelper {
    ...
    private void addHeader(PdfWriter writer){
        ...
        try {
           ...
           // header.getDefaultCell().setBorderColor(BaseColor.RED);
            // add image
            Image logo = Image.getInstance(HeaderFooterOrderPageEvent.class.getResource("/resources/book.png"));
            ...
            text.addElement(new Phrase("    ORDER  LIST", new Font(Font.FontFamily.HELVETICA, 8 ,Font.BOLD)));
    ...
    private void addFooter(PdfWriter writer){
        ...
        try {
            ...
            // add copyright
            footer.addCell(new Phrase("\u00A9 softwarecoding8@gmail.com", new Font(Font.FontFamily.HELVETICA, 12, Font.BOLD)));
